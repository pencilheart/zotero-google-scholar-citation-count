...
$__gscc.app = {
  ...
  init: ({ id, version, rootURI } = {}) => {
    ...
    // Add custom menu item to all windows
  ...
  addToWindow: async function (window) {
    ...
    // Add new menu option for running custom JS code
    const customMenuItem = doc.createElementNS(XUL_NS, 'menuitem');
    customMenuItem.id = 'custom-js-code';
    customMenuItem.classList.add(
      'menuitem-iconic',
      'zotero-menuitem-retrieve-metadata',
    );
